...
import com.bah.rest_server.repository.RegistrationRepository;
...
public class RegistrationAPI {
	...
	public ResponseEntity<?> addRegistration(@RequestBody Registration newRegistration, UriComponentsBuilder uri) {
		...
		if (newRegistration.getId() != 0 || newRegistration.getevent_id() == null || newRegistration.getcustomer_id() == null || newRegistration.getNotes() == null || newRegistration.getregistration_date() == null) {
			...
			@PathVariable("eventId") long eventId) 
	{
		...
		if (newRegistration.getId() != eventId || newRegistration.getevent_id() == null || newRegistration.getcustomer_id() == null || newRegistration.getNotes() == null || newRegistration.getregistration_date() == null) {
			return ResponseEntity.badRequest().build();
		}
		newRegistration = repo.save(newRegistration);
