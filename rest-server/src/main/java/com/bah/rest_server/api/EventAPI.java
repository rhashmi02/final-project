...
import com.bah.rest_server.repository.EventRepository;
...
public class EventAPI {
	...
	public ResponseEntity<?> addEvent(@RequestBody Event newEvent, UriComponentsBuilder uri) {
		...
		if (newEvent.getId() != 0 || newEvent.getCode() == null || newEvent.getTitle() == null || newEvent.getTitle() == null) {
			...
			@PathVariable("eventId") long eventId) 
	{
		...
		if (newEvent.getId() != eventId || newEvent.getCode() == null || newEvent.getTitle() == null || newEvent.getTitle() == null) {
			return ResponseEntity.badRequest().build();
		}
		newEvent = repo.save(newEvent);
